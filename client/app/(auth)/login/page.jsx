        ...
        <div className="relative overflow-hidden rounded-[2rem] bg-blue-600 p-10 text-white shadow-2xl lg:p-16">
          ...
          <div className="mt-12 max-w-lg">
            <h1 className="text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
              AI-Powered Student Group Management
            </h1>
            <p className="mt-5 text-sm leading-7 text-blue-100 sm:text-base">
              Combat social loafing through visual transparency and a strict accountability framework.
            </p>
          </div>
          ...
          <p className="mt-10 text-xs text-blue-100/80">
            Trusted by 500+ university students worldwide
          </p>

          <div className="pointer-events-none absolute -right-16 top-12 h-48 w-48 rounded-full bg-white/10 blur-3xl" />
          <div className="pointer-events-none absolute -bottom-20 left-10 h-44 w-44 rounded-full bg-slate-900/20 blur-3xl" />
        </div>
